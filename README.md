...
**财报分析 Agent** 是基于 [DeerFlow](https://github.com/bytedance/deer-flow) AI 超级代理框架，通过二次开发构建的垂直领域智能代理。专注于 **A 股（沪深）、港股、美股** 上市公司财报分析，支持用户以自然语言提问，自动完成数据获取、财务分析、图表可视化和报告生成。
