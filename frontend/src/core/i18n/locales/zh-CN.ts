...
export const zhCN: Translations = {
  ...
  // Welcome
  welcome: {
    greeting: "你好，欢迎使用 FinMind-wiles！",
    description:
      "📊 FinMind-wiles — 基于 DeerFlow 的财报分析 Super Agent。\n专注 A股/港股/美股 上市公司财报分析，支持自然语言提问，\n自动完成数据获取、指标计算、风险识别和报告生成。",

    createYourOwnSkill: "创建你的分析 Skill",
    createYourOwnSkillDescription:
      "通过自定义 Skill 扩展 FinMind-wiles 的分析能力。\n支持盈利能力、成长性、现金流质量、估值分析等多维度财报分析。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，FinMind-wiles 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 FinMind-wiles 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 FinMind-wiles 官方网站",
    githubTooltip: "访问 FinMind-wiles 的 GitHub 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 FinMind-wiles",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 FinMind-wiles",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 FinMind-wiles Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 FinMind-wiles Bot 接收 Discord 服务器消息。",
      feishu: "通过 FinMind-wiles 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 FinMind-wiles Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 FinMind-wiles Bot 接收微信 iLink 消息。",
      wecom: "通过 FinMind-wiles AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 FinMind-wiles 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 FinMind-wiles。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 FinMind-wiles 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "FinMind-wiles 会在后台不断从你的对话中自动学习。这些记忆能帮助 FinMind-wiles 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 FinMind-wiles 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 FinMind-wiles 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "FinMind-wiles 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，FinMind-wiles 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "FinMind-wiles 需要先创建管理员账号，然后才能创建新的普通账号。",
